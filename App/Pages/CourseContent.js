...
export default function CourseContent({ route, navigation }) {
    const { topic = "Default" } = route.params || {}; 
    const colors = ['#1D92FF', '#D6DEE5', '#D6DEE5', '#D6DEE5', '#D6DEE5']; // Thay đổi màu của dấu gạch chân thứ 2
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                ...
                onPress={() => { navigation.navigate('CourseContent2') }}
            >
...
const styles = StyleSheet.create({
    ...
    runButton: {alignSelf: 'flex-end', // Đặt nút sang bên phải
